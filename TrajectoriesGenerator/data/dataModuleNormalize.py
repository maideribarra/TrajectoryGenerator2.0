...
class DataModuleNormalize(pl.LightningDataModule):
    def __init__(self, train_path, val_path, test_path, batch_size, seq_len):
        super().__init__()
    ...
    def load_dataset(self, path):
        ...
        NParr=np.asarray(arr, dtype=float)[1:, :, 1:]
        print(NParr.shape)
