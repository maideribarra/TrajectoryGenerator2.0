...
class SeqtoSeq(pl.LightningModule):
    ...
    def __init__(self,NUM_SEQ,INPUT_DIM,OUTPUT_DIM,HID_DIM,N_LAYERS,DROPOUT_PROB,LEARNING_RATE,lossFunction):
    ...
    def forward(self, batch):
       # src = [sen_len, batch_size]
        ...
        if batch_size>1:
            ...
            input = torch.zeros(self.num_layers,self.n_features).to(self._device)
            outputs = torch.zeros(self.trg_len,  self.n_features).to(self.device)
